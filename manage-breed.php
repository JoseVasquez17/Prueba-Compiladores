	 ...
	 <div class="w3-row">
	 	...
	 	<div class="col-md-6">
	 		<div class="panel panel-primary">
	 			<div class="panel-heading">Añadir nueva raza</div>
	 			<div class="panel-body">
	 				<form method="post">
	 					<div class="form-group">
	 						<label class="control-label">Nombre de raza</label>
	 						<input type="text" name="breed" class="form-control" placeholder="Ingresar nombre de raza">
	 					</div>

	 					<button class="btn btn-sm btn-default" type="submit" name="submit">Agregar</button>
